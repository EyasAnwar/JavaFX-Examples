...
public class TableViewFromDatabase extends Application {
    ...
    private void initializeDB() {
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/javabook", "phpmyadmin", "root");
        ...
        try {
            ...
            while (rs.next()) {
                Country c = new Country(
                        ...
                        rs.getBoolean("democratic"));
                countries.add(c);
            }
        } catch (SQLException ex) {
            Logger.getLogger(TableViewFromDatabase.class.getName()).log(Level.SEVERE, null, ex);
        }
        return countries;
    }
